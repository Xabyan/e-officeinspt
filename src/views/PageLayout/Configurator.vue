...
<template>
  <div class="fixed-plugin">
    <!-- Button to toggle configurator visibility -->
    <a
    ...
    <!-- Configurator Card -->
    <div class="shadow-lg card" v-if="store.state.showConfig">
      <div class="pt-3 pb-0 bg-transparent card-header">
        <div :class="isRTL ? 'float-end' : 'float-start'">
          <h5 class="mt-3 mb-0">Setting Thema</h5>
          <!-- <p>See our dashboard options.</p> -->
        </div>

        
        <!-- Close Button to hide the Configurator -->
        <div
          class="mt-4"
          @click="toggleConfigurator"
